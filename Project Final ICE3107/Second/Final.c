   ...
   char arrayCC[] = { 0xBF, 0x86, 0xDB, 0xCF, 0xE6, 0xED, 0xFD, 0x87, 0xFF, 0xEF };//char arrayca[] = { 0x40, 0x79, 0x24, 0x30, 0x19, 0x12, 0x02, 0x78, 0x00, 0x10 };

void main() {
    int i;
    int  bt_zero = 0, bt_one = 0, input_value;
   TRISB = 0x00;
   TRISC = 0x00;
   TRISD.f0 = 0xff;
   TRISD.f1 = 0xff;
      ...
      if (input_value >= 1 && input_value <= 99 )

       {
          ...
          if(i==input_value*60)
           ...
           //portd.f4 = 1; // Activate portd.f4           Delay_ms(1000);  // Delay based on input in milliseconds
           //portd.f4 = 0; // Deactivate portd.f4
        }
      }
